      ...
      <div onPaste={aoColar} style={{ ...estilos.card, border: '1px solid rgba(0,120,81,0.14)', padding: largura < 640 ? 16 : '32px 25px', display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        <div>
          ...
          <textarea value={desc} onChange={e => setDesc(e.target.value)} onKeyDown={aoTeclarEnter} placeholder="Ex: impressora do setor não imprime, aparece 'sem papel' mas tem papel na bandeja"
            style={{ ...campoCompacto, minHeight: 140, maxHeight: 260, overflowY: 'auto', resize: 'vertical', lineHeight: 1.5 }} disabled={carregando} />
...
, quer conferir antes de abrir outro?
        ...
        <div>
          ...
          {/* Botão circular discreto (mesmo padrão em CreateTicket.jsx/
              ITAbrirChamado.jsx/ResolutionModal.jsx/TicketPanel.jsx) — no
              lugar da dropzone tracejada grande de antes. Clique abre o
              mesmo seletor de arquivo de sempre; colar (Ctrl+V) continua
              funcionando em qualquer campo do card, sem precisar deste
              botão — ele é só a alternativa pra quem prefere escolher do
              disco, daí o texto ao lado avisando que colar também vale. */}
